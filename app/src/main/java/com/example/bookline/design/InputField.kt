...
object InputFieldDefaults {
    ...
    val shape
        @Composable get() = BooklineTheme.shapes.small

    @Composable
    fun textColor() = BooklineTheme.colors.greyscale900

    @Composable
    fun placeholderColor() = BooklineTheme.colors.greyscale500

    @Composable
    fun focusedBorderColor() = BooklineTheme.colors.primary500
    ...
    @Composable
    fun focusedIconColor() = BooklineTheme.colors.primary500

    @Composable
    fun cursorColor() = BooklineTheme.colors.primary500

    @Composable
    fun selectionColors() = TextSelectionColors(
            handleColor = BooklineTheme.colors.primary500,
            backgroundColor = BooklineTheme.colors.primary300
    )

    @Composable
    fun errorColor() = BooklineTheme.colors.error
}
...
fun InputField(
    ...
    textStyle: TextStyle = BooklineTheme.typography.bodyMediumSemiBold,
