...
@Stable
data class BooklineColorSchema(
        // Main
    val primary500: Color = Color(0xFF1A34B6),
    val primary400: Color = Color(0xFF4876C5),
    val primary300: Color = Color(0xFF76A3D3),
    val primary200: Color = Color(0xFFA3D9E2),
    val primary100: Color = Color(0xFFE8F8F7),

    val secondary500: Color = Color(0xB7FFAC07),
    ...
    val secondary100: Color = Color(0xFFFFFBE6),
        ...
        // Alert & Status
    val success: Color = Color(0xFF241DD6),
    ...
    val buttonDisabled: Color = Color(0xFF4BA3D1),
    ...
    val greyscale50: Color = Color(0xFFFAFAFA),
        ...
        // Gradients
    val gradientGreen: List<Color> = listOf(Color(0xFF086B97), Color(0xFF091D8B)),
...
val booklineColorSchema = BooklineColorSchema()
val LocalBooklineColorSchema = staticCompositionLocalOf { booklineColorSchema }
